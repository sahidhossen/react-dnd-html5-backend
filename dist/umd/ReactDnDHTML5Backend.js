  ...
  var HTML5BackendImpl = /*#__PURE__*/function () {
    ...
    _createClass$4(HTML5BackendImpl, [{
      ...
      value: function connectDragPreview(sourceId, node, options) {
        ...
        return function () {
          _this4.sourcePreviewNodes.delete(sourceId);

          _this4.sourcePreviewNodeOptions.delete(sourceId);
        };
      }
    }, {
      ...
      value: function connectDragSource(sourceId, node, options) {
        ...
        return function () {
          _this5.sourceNodes.delete(sourceId);

          _this5.sourceNodeOptions.delete(sourceId);
      ...
      value: function setCurrentDragSourceNode(node) {
        ...
        this.mouseMoveTimeoutTimer = setTimeout(function () {
          return _this7.window && _this7.window.addEventListener('mousemove', _this7.endDragIfSourceWasRemovedFromDOM, true);
        }, MOUSE_MOVE_TIMEOUT);
      }
    }, {
